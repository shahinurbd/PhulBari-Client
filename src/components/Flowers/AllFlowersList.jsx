...
import FlowerDialoag from "../FlowerDetails/FlowerDialog";

const AllFlowerList = ({ products, isLoading }) => {
    ...
    return (
      <>
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-2 gap-8 font-[Poppins]">
                        ...
                        <div className="relative overflow-hidden">
                          ...
                          <div className="group relative md:max-h-75 sm:max-h-60 max-h-35 flex items-center justify-center bg-gray-50">
                            ...
                            <img
                              ...
                              alt={product.name}
                              className="min-h-40 md:min-h-65 object-contain transform hover:scale-110 transition duration-400 aspect-square"
                            />
                            </Link>
